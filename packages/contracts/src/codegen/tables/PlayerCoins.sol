...
library PlayerCoins {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "PlayerCoins", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000506c61796572436f696e730000000000);
   ...
   * @notice Get amount.
   */
  function getAmount(address player) internal view returns (uint32 amount) {
   ...
   * @notice Get amount.
   */
  function _getAmount(address player) internal view returns (uint32 amount) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get amount.
   */
  function get(address player) internal view returns (uint32 amount) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get amount.
   */
  function _get(address player) internal view returns (uint32 amount) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set amount.
   */
  function setAmount(address player, uint32 amount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set amount.
   */
  function _setAmount(address player, uint32 amount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set amount.
   */
  function set(address player, uint32 amount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set amount.
   */
  function _set(address player, uint32 amount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
