...
library BombsCommitment {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "BombsCommitment", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000426f6d6273436f6d6d69746d656e7400);
